...
// This file is imported by the simulation adapter for fee tables only. Keep the
// legacy CD export from crashing module evaluation when transaction data is not
// loaded through the old hardcoded data path.
const ALL_TXNS = [];
